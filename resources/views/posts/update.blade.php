@extends('layouts.app')
    ...
    @endsection
    @section('content')
        <form method='post' action="{{route('posts.update',['task'=>$task->id])}}" class="row row-cols-lg-auto g-3 align-items-center bg-dark p-3 rounded m-auto" style="width:500px">
            @csrf
            @method('PUT')
            <div class="col-12">
